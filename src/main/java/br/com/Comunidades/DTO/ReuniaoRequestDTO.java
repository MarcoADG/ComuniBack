...
public class ReuniaoRequestDTO {
	...
	public ReuniaoRequestDTO(LocalDateTime dataHora, String tema, String imagem, String responsavel, String descricao,
			String material, String gravacao, String resumo, Boolean estado) {
		super();
		this.dataHora = dataHora;
		this.tema = tema;
		this.imagem = imagem;
